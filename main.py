...
def q3():
  print ("This is question 3, Fill in the blank for the song - One day a ____ went swimming in the moana. Taniwha / Mokopuna / Tuna")
  
def q4():
  print ("This is question 4, What is the maori word for ocean?Wai / Moana")
  
def q5():

  print ("This is question 5, Niu Tireni is the Māori word for New Zealand. False / True")
